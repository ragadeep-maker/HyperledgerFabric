...
func (s *SmartContract) InitLedger(ctx contractapi.TransactionContextInterface) error {
	...
	for _, asset := range assets {
		...
		// returning the data the database
		//
...
func (s *SmartContract) CreateAsset(ctx contractapi.TransactionContextInterface, id string, energy string, requiredenergy int, owner string, price int) error {
...
func (s *SmartContract) UpdateAsset(ctx contractapi.TransactionContextInterface, id string, energy string, requiredenergy int, owner string, price int) error {
	exists, err := s.AssetExists(ctx, id)
	if err != nil {
		return err
	}
